...
# Q.3  a)
create table countries ( name char , population int, capital char );
alter table countries modify name char(25),modify capital char (25);
select * from countries;
insert into countries values ( 'China', 1382,'Beijing'),
		("India",1326,'Delhi'),('United States',324,'Washington D.C.'),('Indonesia',260,'Jakarta'),
('Brazil',209,'Brasilia'),
...
# Q.3(b)
insert into countries values('Australia',25,'Canberra'),
('Austria',13,'Vienna'),
('Serbia',32,'Belgrade');
select * from countries;
...
values('Tata','Pune'),('Mahindra','Nashik'),('Maruti','Gudgaon');

insert into product (product_name,description,supplier_id)
values('Tiago','Hatchback',1), 
('Harrier','SUV',1),('Hexa','MVP',1),('XUV300','Hatchback',2),('XUV700','SUV',2),('Marazzo','MVP',2),
('Baleno','Hatchback',3),('Gypsy','SUV',3),('Ertiga','MVP',3);

insert into stock (product_id,balance_stock)
values(1,5),(2,7),
(6,8),(8,23),(3,5),(4,54),(7,4),(8,2),(5,7);
...
(10004,'1954-05-01','Chirstian','Koblick','M','2020-04-15',3475.00),(10005,'1955-01-21','Kyoichi','Maliniak','M','2019-12-27',1756.50),(10006,'1953-04-20','Anneke','Preusig','F','2020-02-23',7850.00),(10007,'1957-05-23','Tzvetan','Zielinski','F','2020-02-23',7850.00),(10008,'1958-02-19','Saniya','Kalloufi','M','1994-09-15',6759.00),(10009,'1952-04-19','Sumant','Peac','F','2020-02-23',7850.00),
(10010,'1963-06-01','Duangkaew','Piveteau','F','2019-12-27',1375.00),(10011,'1953-11-07','Mary','Sluis','F','1990-01-22',6759.00),(10012,'1960-10-04','Patricio','Bridgland','M','1992-12-18',3475.00),
